   ...
   <div className="bg-gray-500">
    <Navbar/>
        ...
        <Routes>
          ...
          <Route path="/administrator/login" element={!isAdmin ? <LoginAdmin/> : <Navigate to='/'/>}/>
          <Route path="/administrator/createAdmin" element={isAdmin ? <CreateAdmin/>:<Navigate to='/administrator/login'/>}/>
